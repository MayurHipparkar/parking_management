                ...
                <div id="signUpForm">                     
                    ...
                    <form action="${pageContext.request.contextPath}/registeruser" method="post">                         
                        <div class="mb-3">                             
                            ...
                            <input type="text" class="form-control" id="fullname" name="fullname" placeholder="e.g., name" pattern="[A-Za-z ]{2,50}" title="Name should contain only letters and spaces (2–50 characters)" required>                         
                        </div>                         
                        <div class="mb-3">                             
                        ...
                        <div class="mb-3">                             
                            ...
                            <input type="text" class="form-control" id="signupNumber" name="number" pattern="[6-9][0-9]{9}" title="Enter a valid 10-digit mobile number starting with 6, 7, 8, or 9" maxlength="10" placeholder="Enter your number" required />                         
                        </div>                         
                        <div class="mb-3">                             
                            <label for="signupEmail" class="form-label">Address</label>                             
                            <input type="text" class="form-control" id="signupAddress" name="address" pattern="[A-Za-z ]{2,100}" title="Address should contain only letters and spaces (2–100 characters)" placeholder="Enter your address" required />                         
                        </div>                         
                        <div class="mb-3">                             
                            <label for="password" class="form-label">Password (Auto-generated)</label>                             
                            <input type="text" class="form-control" id="password" name="password" readonly placeholder="Auto-generated from name">                         
                        </div>                         
                        <div class="mb-3">                             
